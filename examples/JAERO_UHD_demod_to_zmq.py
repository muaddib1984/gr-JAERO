...
class JAERO_UHD_demod_to_zmq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "JAERO_UHD_demod_to_zmq")
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.qtgui_freq_sink, 0))
...
def main(top_block_cls=JAERO_UHD_demod_to_zmq, options=None):
