...
class JAERO_stillsuit_demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "JAERO Stillsuit Demodulator", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("JAERO Stillsuit Demodulator")
        ...
        self.settings = Qt.QSettings("GNU Radio", "JAERO_stillsuit_demod")
...
def main(top_block_cls=JAERO_stillsuit_demod, options=None):
