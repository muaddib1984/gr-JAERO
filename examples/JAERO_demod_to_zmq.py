...
class JAERO_demod_to_zmq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "JAERO_demod_to_zmq")
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_1_0_0_win, 0, 0, 1, 2)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_win, 0, 2, 1, 2)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink.set_frequency_range(1555622487, self.samp_rate)
...
def main(top_block_cls=JAERO_demod_to_zmq, options=None):
