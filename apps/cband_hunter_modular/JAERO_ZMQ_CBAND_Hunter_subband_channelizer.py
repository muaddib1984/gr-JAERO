...
class JAERO_ZMQ_CBAND_Hunter_subband_channelizer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, port_start='6001', samp_rate=2.16e6, wtf_port_start='7001', zmq_port=5001):
        ...
        self.JAERO_zmq_sink_0_4_2 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[10]), 'eleven', 48000)
        self.JAERO_zmq_sink_0_4_1_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[7]), 'eighteight', 48000)
        self.JAERO_zmq_sink_0_4_1 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[0]), 'JAERO', 48000)
        self.JAERO_zmq_sink_0_4_0_2 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[11]), 'twelve', 48000)
        self.JAERO_zmq_sink_0_4_0_1_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[8]), 'ninenine', 48000)
        self.JAERO_zmq_sink_0_4_0_1 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[1]), 'twotwo', 48000)
        self.JAERO_zmq_sink_0_4_0_0_1 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[12]), 'thirteen', 48000)
        self.JAERO_zmq_sink_0_4_0_0_0_0_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[14]), 'fifteen', 48000)
        self.JAERO_zmq_sink_0_4_0_0_0_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[13]), 'fourteen', 48000)
        self.JAERO_zmq_sink_0_4_0_0_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[6]), 'sevenseven', 48000)
        self.JAERO_zmq_sink_0_4_0_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[5]), 'sixsix', 48000)
        self.JAERO_zmq_sink_0_4_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[4]), 'fivefive', 48000)
        self.JAERO_zmq_sink_0_4 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[3]), 'fourfour', 48000)
        self.JAERO_zmq_sink_0_1 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[9]), 'tenten', 48000)
        self.JAERO_zmq_sink_0 = JAERO.JAERO_zmq_sink(str("tcp://127.0.0.1:")+str(ports[2]), 'threethree', 48000)
